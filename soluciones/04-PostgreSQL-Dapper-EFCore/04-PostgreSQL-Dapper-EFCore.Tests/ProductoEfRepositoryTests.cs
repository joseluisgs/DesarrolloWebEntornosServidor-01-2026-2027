...
/// <summary>
/// Tests de integración de ProductoEfRepository usando TestContainers.
/// Cada suite crea un contenedor PostgreSQL efímero con Docker.
/// </summary>
[TestFixture]
public class ProductoEfRepositoryTests
{
    private PostgreSqlContainer _container = null!;
    private AppDbContext _context = null!;
    private ProductoEfRepository _repository = null!;
    ...
    public async Task SetUp()
    {
        ...
        _repository = new ProductoEfRepository(_context);
    }
    ...
    [TestFixture]
    public class CasosPositivos : ProductoEfRepositoryTests
    {
        [Test]
    ...
    [TestFixture]
    public class CasosNegativos : ProductoEfRepositoryTests
    {
        [Test]
